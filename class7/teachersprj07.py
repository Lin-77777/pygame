...
######################字型設定######################
font = pygame.font.Font("C:/Windows/Fonts/msjh.ttc", 24)  # 設定字型和大小為微軟正黑體24點
...
while True:
    ...
    # 如果遊戲結束，顯示遊戲結束訊息和最高分
    if game_over:
        game_over_text = font.render("遊戲結束！按任意鍵重新開始", True, (255, 255, 255))
        highest_score_text = font.render(f"最高分數: {highest_score}", True, (255, 255, 255))
