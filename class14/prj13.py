...
class CollisionManager:
    def __init__(self, missile_list, emy_list, score_manager=None, audio_manager=None):
        """
        初始化碰撞管理器
        missile_list: 飛彈物件列表
        emy_list: 敵機物件列表
...
# #################### 主程式 ####################
# 初始化碰撞管理器，傳入飛彈與敵機列表、分數與音效管理器
collision_manager = CollisionManager(missiles, emy_list, score_manager, audio_manager)
